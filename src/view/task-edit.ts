...
const createTaskEditDateTemplate = (dueDate: Date | null, isDueDate: boolean): string => {
...
const createTaskEditRepeatingTemplate = (repeatingMask: number, isRepeating: boolean): string => {
